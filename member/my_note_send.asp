			...
			<div class="body"> 
				...
				<div class="body_shop">
					<div class="meminfo_div">
						<h1 class="h1_stitle">보낸 쪽지함<span class="title_coment">고객님이 다른 사용자에게 보낸 쪽지를 확인하실 수 있습니다.</span></h1>
						<div class="coment_div">
							<ul class="comnt_ul">
								<li><span class="fbo">상대방의 쪽지 수신여부를 확인하실 수 있으며, 미확인 상태인 경우 쪽지취소가 가능합니다.</li>
							</ul>
							<a href="#" class="red_btn_big2 absolute" style="right:20px; top:6px"><span>쪽지쓰기</span></a> </div>
						<div class="p_20">
							<div class="lst_spot2"> <span class="select_area"> 선택한 쪽지를 <a href="#" class="btn"><span>삭제</span></a>&nbsp;<a href="#" class="btn"><span>취소</span></a></span></div>
							<table class="lst_tbl_style1" width="100%">
								...
								<tbody class="nodata_tbody" style="display:">
									<tr>
										<td colspan="5" class="nodata_tbody">쪽지가 없습니다.</td>
									</tr>
								</tbody>
