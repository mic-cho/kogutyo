    ...
    d.prototype = {
        ...
        k: function(b, c) {
            if (document.cookie.indexOf("tabContent=") == -1) document.cookie = "tabContent=" + a + b + "=" + c + ";path=/";
                ...
                var e = new RegExp(a + b + "=\\d+", "g"),
                    d = document.cookie.replace(e, a + b + "=" + c);
