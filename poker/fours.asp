...
<!--#include virtual="/inc/top.asp" -->
	...
	<div id="container" class="container_baduki container_fours">

		<div id="content">

			<div class="gamemain">
				<h2><a href="/poker/fours.asp"><img src="/poker/img/logo_fours.png"></a></h2>
				...
				<p class="banner"><a href="javascript:ready();"><img src="/poker/img/banner_vip.png"></a></p>
			</div>
