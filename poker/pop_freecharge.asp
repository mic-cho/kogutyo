	...
	<div id="pop_container">
		<div id="pop_content">
			...
			<div class="section_freecharge" style="display:none">
				...
				<div>
					<strong>게임 기록이 없어, 무료충전 혜택 대상이 아닙니다.<br>지금 망고 포커게임을 즐겨보세요!</strong>
				</div>
			</div>
			<!--무료충전 불가능(게임기록없음):end-->
			...
			<div class="section_adpass">
				<p><img src="/common/img/pass/vip1.png" title="포커패스"></p>
				<ul>
				<li class="bgx"><b class="f12"><strong class="fc_2a696e">VIP 플러스 블루</strong>를 이용해보세요!</b></li>
