...
<%
	Sql = "Select Top 1 * From board_body Where bb_idx = ? And bh_idx= 3"
...
<div id="pop_wrap">
	...
	<div id="pop_container">
		<div id="pop_content">
			...
			<p class="search"><input type="text" class="input" id="s_name"><a href="javascript:" class="btn_cs" onClick="MovePage('pop_faq_list.asp?s_name=' + $('#s_name').val())">검색</a></p>
			...
			<div class="wrap_btn_board"><a href="/cs/pop_faq_list.asp" class="btn_cs">목록</a></div>
