			...
			<div class="body"> 
				...
				<div class="body_cs">
					<div class="cs_div">
						...
						<table class="tbl_style4">
							<tr>
								...
								<td><ul class="inquiry_class">
										...
										<li>
											<input type="radio" id="declaration">
										...
										<li>
											<input type="radio" id="suggestion">
										...
										<li>
											<input type="radio" id="bug">
											<label for="bug">게임버그신고</label>
										</li>
									</ul></td>
							</tr>
							<tr>
								<th scope="row"><span class="ico chk"></span>제목</th>
								<td><input type="text" class="ipstyle_wide"></td>
							</tr>
							<tr>
								<th scope="row"><span class="ico chk"></span>내용</th>
								<td><textarea class="ipstyle_text"></textarea></td>
							</tr>
							<tr>
								<th scope="row">이메일 답변동의</th>
								<td><input type="text" id="" name="" class="ipstyle_normal">
									@
									<input type="text" id="" name="" class="ipstyle_normal">
							...
							<tr>
								...
								<td><select class="select_phone" name="" id="">
									...
									-
									<input name="" type="text" class="ipstyle_phone" id="" onKeyUp="" maxlength="">
									-
									<input name="" type="text" class="ipstyle_phone" id="" onKeyUp="" maxlength="">
									<p class="m_t_5">
						...
						<div class="wrap_btn"><a href="#" class="darkgray_btn">작 성</a> <a href="#" class="gray_btn">취 소</a></div>
					</div>
				</div>
			</div>
		</div>
