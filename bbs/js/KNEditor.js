...
//****************************************************************************************
	...
	//**	스타일 출력
		var Editor_Root_Dir = "/bbs/js";
		var Style	=	'<style type="text/css">\n';
			Style	+=	'	textarea			{font-size: 9pt; font-family: 굴림, 돋음; border:1px solid #D7D7D7; padding-left:5px;background-color:#FBFBFB;color:999999}\n';
			Style	+=	'	.Editor_Tool		{border-collapse: collapse; background-color: #999999; margin: 0; padding: 0;}\n';
			Style	+=	'	.Editor_Btn_Default	{cursor:hand; width: 23px; height: 22px; border: 0px solid #7F8180; background-color: #999999;}\n';
			Style	+=	'	.Editor_Btn_Over	{cursor:hand; width: 23px; height: 22px; border: 1px solid #7F8180; background-color: #999999;}\n';
			Style	+=	'	.Editor_Btn_Down	{cursor:hand; width: 23px; height: 22px; border: 1px solid #999999;;}\n';
			Style	+=	'	.Editor_Btn_Disable	{cursor:default; width: 23px; height: 22px; border: 1px solid #C9C7BA;background-color:#F0F0EA;}\n';
			Style	+=	'	.Editor_Btn2_Default{cursor:hand; border: 1px solid #999999;}\n';
			Style	+=	'	.Editor_Btn2_Over	{cursor:hand; border: 1px solid #7F8180; background-color: #999999;}\n';
			Style	+=	'	.Editor_Btn2_Check	{cursor:hand; border: 1px solid #7F8180; background-color: #999999;}\n';
			Style	+=	'	.Editor_Select		{cursor:hand; border: 1px solid #808080; font-size: 9pt;color:#000000}\n';
	...
	-------------------------------------------------------------------*/
		...
		function Editor_Defaule_Config(EditorObjName){
			...
			this.DefaultStyle	=	  '<style type="text/css">\n'
									+ '	body	{font-size: 10pt; font-family: 굴림, 돋음; font-style:  normal; font-weight: normal;scrollbar-face-color: #F0F0F0;'
...
//										['InsertHorizontalRule', 'CreateLink', 'InsertImage', ]
	...
	-------------------------------------------------------------------*/
		...
		function Editor_New_Generate(EditorObjName, CustomEditorConfigObj){
			...
			//**	전체적인 에디터 모양 만들기
				//**	버튼 외곽 테이블 HTML
					var HTML_Table_Open		=	'<span style="float: left; padding:2px 2px">';
					var HTML_Table_Close	=	'</span>';
...
//									HTML_Toolbar	+=	'<span class="Editor_Separator"></span>'
				...
				//**	전체 HTML 에디터 모양 만들기
					var HTML_Editor	=	'';
						...
						HTML_Editor	+=	'<table  class="Editor_Tool" border="0" cellpadding="1" cellspacing="0" width="'+ ConfigObj.Width+'" height="'+ ConfigObj.Height +'" style="border-collapse: collapse;"><tr><td>';
						HTML_Editor	+=	'<div id="Editor_ToolBar"><div class="Editor_Tool" style= width:"'+ ConfigObj.Width +'">';
						HTML_Editor	+=	HTML_Toolbar;
						HTML_Editor	+=	'</div>';						
						HTML_Editor	+=	'<div><textarea id="Editor__'+ EditorObjName +'__EditorPad" style="width:'+ ConfigObj.Width +'; height:'+ ConfigObj.Height +';font-size:12px; border:1px solid #C4C4C4; padding-left:5px; background-color:#D7D7D7; color:#646464 "></textarea>';
						HTML_Editor	+=	'</div><div>';						
