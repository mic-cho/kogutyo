...
<!--#include virtual="/inc/top.asp" -->
	...
	<div id="container" class="container_matgo">

		<div id="content">

			<div class="gamemain">
				<h2><a href="/gostop/matgo.asp">망고맞고<span>둘이서 알콩달콩!</span></a></h2>
				<!--#include virtual="/gostop/menu.asp" -->
				<!--#include virtual="/gostop/channel_matgo.asp" -->
				...
				<p class="banner"><a href="javascript:ready();"><img src="/poker/img/banner_vip.png" title="vip"></a></p>
			</div>
			...
			<div class="license"><p><img src="/gostop/img/license_matgo.gif"></p></div>
		</div>
	</div>
